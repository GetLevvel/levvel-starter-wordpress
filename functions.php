...
// Get partial templates with arguments
...
function html5blank_styles()
{
    ...
    wp_register_style('html5blanktheme', get_template_directory_uri() . '/theme.css', array(), '1.0', 'all');
    wp_enqueue_style('html5blanktheme'); // Enqueue it!
}
